...
SHAP-flagged noise (weak correlation, absent from ground truth) fail it \--
the intended separation, though demonstrated here on one incident rather
than across a statistically powered sample (Section 8).
